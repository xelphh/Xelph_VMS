...
Abstract:
    ...
    Declaration of CSaveData, which optionally writes rendered PCM out to a
    .wav file on disk for debugging (enabled via the DoNotCreateDataFiles
    registry setting - see driverinit.cpp).
