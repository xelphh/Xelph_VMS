...
Abstract:
    ...
    Implementation of CSaveData, the optional debug .wav writer. Maintains a
    circular buffer split into fixed-size frames; once a frame fills up, a
    work item is queued to flush it to disk asynchronously so the streaming
    path is never blocked on file I/O.
...
#define DEFAULT_FILE_FOLDER2        L"\\DriverData\\Audio_Samples\\XelphVMS"
#define DEFAULT_FILE_NAME           L"\\DriverData\\Audio_Samples\\XelphVMS\\STREAM"
