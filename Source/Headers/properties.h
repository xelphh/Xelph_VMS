...
Abstract:
    ...
    Declares the shared KS property handlers (volume, mute, peak meter,
    basic-support, CPU resources) and the PropertyDispatch/thunk-macro
    machinery used to wire a class method up as a property handler - see
    Utilities/properties.cpp for the implementations.
