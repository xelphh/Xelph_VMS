...
Abstract:
    ...
    Declaration of CTopologyBase, the shared base implementation of the KS
    topology miniport used by both the speaker and microphone topology
    filters (see Main/topologybase.cpp).
...
#ifndef _TOPOLOGYBASE_H_
#define _TOPOLOGYBASE_H_
