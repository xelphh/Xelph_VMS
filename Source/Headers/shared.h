...
Abstract:
    ...
    Driver-wide constants, macros, and typedefs pulled in by nearly every
    other source file: the product ID GUID, pool tag and debug-print
    macros, volume/peak-meter normalization macros, pin-instance-counting
    helpers, the PortCls device-extension layout, and the global registry
    setting externs. Also pulls in devicecontext.h and properties.h so a
    single #include "shared.h" is enough for most files.
...
#define STATIC_PID_XELPH_VMS\
    0x836ba6d1, 0x3ff7, 0x4411, 0x8b, 0xcd, 0x46, 0x95, 0x53, 0x45, 0x2d, 0xce
DEFINE_GUIDSTRUCT("836BA6D1-3FF7-4411-8BCD-469553452DCE", PID_XELPH_VMS);
#define PID_XELPH_VMS DEFINE_GUIDNAMED(PID_XELPH_VMS)

// Pool tag used for XELPH_VMS allocations
#define DRIVER_POOLTAG               'SASM'  

// Debug module name
#define STR_MODULENAME              "XELPH_VMS: "
...
extern DWORD g_DisableLoopback;
...
// devicecontext.h uses some of the above definitions.
