...
Module Name:
    ...
    inputtopologytables.h

Abstract:

    KS pin/node/connection descriptor tables for the microphone's topology
...
#ifndef _INPUTTOPOLOGYTABLES_H_
#define _INPUTTOPOLOGYTABLES_H_
