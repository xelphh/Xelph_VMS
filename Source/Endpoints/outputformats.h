...
Abstract:
    ...
    Supported wave formats, pin/node/connection descriptor tables, and
    channel/rate/bit-depth constants for the speaker's wave (WaveRT) filter.
...
#ifndef _OUTPUTFORMATS_H_
#define _OUTPUTFORMATS_H_
