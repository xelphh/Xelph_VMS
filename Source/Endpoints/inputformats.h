...
Abstract:
    ...
    Supported wave format(s), pin/node/connection descriptor tables, and
    channel/rate constants for the microphone's wave (WaveRT) filter.
...
#ifndef _INPUTFORMATS_H_
#define _INPUTFORMATS_H_
...
static
AUDIO_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
