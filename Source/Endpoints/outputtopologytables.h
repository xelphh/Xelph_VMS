...
Module Name:
    ...
    outputtopologytables.h

Abstract:

    KS pin/node/connection descriptor tables for the speaker's topology
    filter (data ranges, pins, nodes, connections, and the filter
...
#ifndef _OUTPUTTOPOLOGYTABLES_H_
#define _OUTPUTTOPOLOGYTABLES_H_
...
#endif // _OUTPUTTOPOLOGYTABLES_H_
