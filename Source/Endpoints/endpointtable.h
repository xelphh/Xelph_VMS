...
Abstract:
    ...
    Wires up each endpoint's ENDPOINT_MINIPAIR (topology+wave miniport
    factories, filter descriptors, formats, and bridge-pin physical
    connections) and exposes the g_RenderEndpoints/g_CaptureEndpoints
    tables that driverinit.cpp iterates over at StartDevice time.
...
#ifndef _ENDPOINTTABLE_H_
#define _ENDPOINTTABLE_H_
